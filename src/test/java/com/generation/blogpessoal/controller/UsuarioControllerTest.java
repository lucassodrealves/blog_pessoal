...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, 
			"Paulo Mario", "paulo_mario@email.com.br", "13465278", "https://i.imgur.com/JR7kUFU.jpg"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		HttpEntity<String> requisicao = new HttpEntity<String>(usuarioRepository.findAll().toString());

		ResponseEntity<String> resposta = testRestTemplate
			.withBasicAuth("root", "root")
			.exchange("/usuarios/all", HttpMethod.GET, requisicao, String.class);
